...
NO_REL_TYPES = ["OrganismTaxon", "CellLine", "Species"]
...
def main():
    ...
    input_file = "./pubmed_random_100.json"
    output_file = "./pubmed_random_100_updated.json"
    ...
    for entry in data:
        for entity in entry['entities']:
            entity["type"] = type_name_mapping[entity["type"]]

        for relation in entry["relation"]:
            ent1_type = relation["ent1"]["type"]
            ent2_type = relation["ent2"]["type"]
            relation["ent1"]["type"] = type_name_mapping[ent1_type]
            relation["ent2"]["type"] = type_name_mapping[ent2_type]
