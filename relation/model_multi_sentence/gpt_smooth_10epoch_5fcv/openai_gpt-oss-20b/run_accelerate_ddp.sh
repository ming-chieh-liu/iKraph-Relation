#!/bin/bash
# Launch script for multi-GPU training with DDP for gpt-oss-20b
# Supports MXFP4 + QLoRA two-stage quantization pipeline
...
accelerate launch \
    ...
    "${SCRIPT_DIR}/modeling_accelerate.py" "$TEMP_CONFIG"
