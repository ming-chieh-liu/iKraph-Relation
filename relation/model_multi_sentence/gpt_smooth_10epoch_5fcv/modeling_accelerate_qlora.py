...
class SaveBestModelCallback(TrainerCallback):
    ...
    - checkpoint-best/: Saved during on_evaluate when metric improves, and during on_train_end
    - checkpoint-last/: Saved once at end of training in on_train_end
    """
    ...
    def set_trainer(self, trainer):
        """Set trainer reference for final evaluation in on_train_end."""
    ...
    def on_evaluate(self, args, state, control, metrics=None, **kwargs):
        ...
        checkpoint-last/ is saved once in on_train_end.
        """
    ...
    def on_train_end(self, args, state, control, **kwargs):
        ...
        1. Runs a final evaluation to get metrics
        2. Saves checkpoint-last/ (always)
        3. Saves checkpoint-best/ (if final eval metric improved)
        """
        if not self.enable_saving:
            return

        # Disable on_evaluate saving so our evaluate() call doesn't trigger checkpoint-best
