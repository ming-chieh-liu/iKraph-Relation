...
train_data_path = os.path.join(".", "processed", "processed_all.json")
no_rel_path = os.path.join(".", "multi_sentence_split_litcoin_600", "no_rel.csv")
...
for elem in train_data:
    entity_a_type = elem["entity_a_info"][0]["type"]
    entity_b_type = elem["entity_b_info"][0]["type"]
