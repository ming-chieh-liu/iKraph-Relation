...
class RobertaTripletClassifcationHead(nn.Module):
    ...
    def forward(self, features, positions, **kwargs):
        ...
        x = torch.gather(features, 1, positions_exp)
...
class RobertaTripletForSequenceClassification(RobertaForSequenceClassification):
    def __init__(self, config):
        super().__init__(config)
        self.classifier = RobertaTripletClassifcationHead(config)
